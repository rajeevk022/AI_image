    ...
    st.components.v1.html(
        ...
        <script>
          var opt = {{
            ...
            theme:{{color:"#ff4f9d"}},
            handler:function(){{var msg=document.createElement('p');msg.innerText='Payment successful! Redirecting...';msg.style='font-size:1.2rem;color:green;text-align:center;margin-top:15px;';document.body.appendChild(msg);setTimeout(function(){{window.parent.postMessage({type:"streamlit:rerun"},"*");}},1500);}}
          }};
